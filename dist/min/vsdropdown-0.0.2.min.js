...
angular.module("vsscrollbar", ["template-vsdropdown-0.0.2.html"]).constant("vsscrollbarConfig", {
  ITEMS_IN_PAGE: 6,
  SCROLLBAR_HEIGHT: 0,
  ...
  return {
    ...
    link: function (b, c, d) {
      ...
      function g() {
        return b.focusIdx === b.options.visibleItemCount - 1 || b.focusIdx === b.filteredItemCount - 1
      }
      ...
      b.selectedItems = [], b.showSelector = !1;
      var i = !1;
      b.selector = function () {
        b.showSelector = !b.showSelector, b.showSelector && (b.listFocusEvent(), b.focusIdx = 0)
        ...
        b.isItemSelected(c) ? b.removeItem(b.selectedItems.indexOf(c)) : b.addItem(c), 1 === b.options.selection.maximum ? b.showSelector = !1 : b.focusIdx = a
        ...
        (a === b.selectedItems.length - 1 || 2 === b.selectedItems.length) && b.closeOverlay(), b.selectedItems.splice(a, 1), f(c, b.config.OPERATION_DEL)
      ...
      }, b.onFocusScrollbox = function (a) {
        i = a
      }, b.keyDown = function (c) {
        i || ((13 === c.which || 38 === c.which || 40 === c.which || 27 === c.which) && c.preventDefault(), 13 === c.which && b.focusIdx > -1 ? b.itemClicked(b.focusIdx) : 38 === c.which ? 0 === b.focusIdx ? (a.setIndex(b, b.topIndex - b.options.visibleItemCount), b.focusIdx = b.filteredItemCount < b.options.visibleItemCount ? b.filteredItemCount - 1 : b.options.visibleItemCount - 1) : b.focusIdx-- : 40 === c.which ? g() ? (a.setIndex(b, b.topIndex + b.options.visibleItemCount), b.focusIdx = 0) : b.focusIdx++ : 27 === c.which && (b.showSelector = !1))
      };
      var j = b.$watch("filterText", e);
