...
angular.module("vsscrollbar", ["template-vsdropdown-0.0.1.html"]).constant("vsscrollbarConfig", {
  ITEMS_IN_PAGE: 6,
  SCROLLBAR_HEIGHT: 0,
  ...
  return {
    restrict: "AE",
    scope: {ngModel: "=?", items: "=items", onScrollChangeFn: "&"},
    transclude: !0,
...
}).directive("vsdropdown", ["vsscrollbarEvent", function (a) {
  return {
    restrict: "EA",
    templateUrl: "templates/vsdropdown.html",
    scope: {options: "="},
    controller: ["$scope", "vsdropdownConfig", function (a, b) {
      a.config = b, a.filterText = "", a.showOverlay = !1, a.topIndex = 0, a.focusIdx = -1, a.filterFocusEvent = function () {
        a.$broadcast(a.config.FILTER_FOCUS_EVENT)
      }
    }],
    link: function (b, c, d) {
      function e(c, d) {
      ...
      function f(a, c) {
        angular.isUndefined(b.options.itemSelectCb) || b.options.itemSelectCb(b.selectedItems, a, c)
      }

      function g() {
        b.visiblePropName = b.options.input.isObject ? b.options.input.visiblePropName : null, b.selectedItems = b.options.selectedItems
      }

      b.selectedItems = [], b.showSelector = !1, b.selector = function () {
        b.showSelector = !b.showSelector, b.showSelector && b.filterFocusEvent()
      }, b.openOverlay = function () {
        b.showSelector && b.selector(), b.showOverlay = !0
      }, b.closeOverlay = function () {
        b.showOverlay = !1
      }, b.itemClicked = function (a) {
        var c = b.visibleItems[a];
        b.isItemSelected(c) ? b.removeItem(b.selectedItems.indexOf(c)) : b.addItem(c), 1 === b.options.selection.maximum ? b.selector() : b.showSelector && b.filterFocusEvent()
      }, b.addItem = function (a) {
        b.options.selection.maximum > 1 ? (b.selectedItems.length === b.options.selection.maximum && b.removeItem(b.selectedItems.length - 1), b.selectedItems.push(a)) : b.selectedItems[0] = a, f(a, b.config.OPERATION_ADD)
      }, b.removeItem = function (a) {
        var c = b.selectedItems[a];
        (a === b.selectedItems.length - 1 || 2 === b.selectedItems.length) && b.closeOverlay(), b.selectedItems.splice(a, 1), f(c, b.config.OPERATION_DEL), b.filterFocusEvent()
      }, b.isItemSelected = function (a) {
        return -1 !== b.selectedItems.indexOf(a)
      }, b.onScrollChange = function (a, c, d, e, f, g, h) {
        b.topIndex = a, b.filteredItemCount = g, b.visibleItems = h
      };
      var h = b.$watch("filterText", e);
      b.$on("$destroy", function () {
        h()
      }), g()
    }
  }
}]).directive("filterFocus", ["$timeout", "vsscrollbarEvent", function (a, b) {
  return {
    restrict: "A", scope: !1, link: function (c, d, e) {
      ...
      function g(a) {
        c.$apply(function () {
          13 === a.which && c.focusIdx > -1 ? c.itemClicked(c.focusIdx) : 38 === a.which ? 0 === c.focusIdx ? (b.setIndex(c, c.topIndex - c.options.visibleItemCount), c.focusIdx = c.filteredItemCount < c.options.visibleItemCount ? c.filteredItemCount - 1 : c.options.visibleItemCount - 1) : c.focusIdx-- : 40 === a.which ? h() ? (b.setIndex(c, c.topIndex + c.options.visibleItemCount), c.focusIdx = 0) : c.focusIdx++ : 27 === a.which && (c.showSelector = !1)
        })
      }
      ...
      function i() {
        d.on("blur", f), d.on("keydown", g)
      }

      c.$on(c.config.FILTER_FOCUS_EVENT, function () {
        a(function () {
          d[0].focus()
        })
      }), c.$on("$destroy", function () {
        d.off("keydown", g), d.off("blur", f)
      }), i()
    }
  }
      ...
      function h() {
        f[0].scrollWidth > f[0].offsetWidth && (n = b(function () {
          c.get("vstooltip.html", {cache: d}).success(function (b) {
            m = angular.element(b.replace("txt", g.tooltipWindow)), f.append(a(m)(e))
          })
