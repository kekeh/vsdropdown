  ...
  return {
    ...
    link: function (b, c, d) {
      ...
      b.selector = function () {
        ...
        b.showOverlay = !1
      }, b.itemClicked = function (a, c) {
        var d = b.visibleItems[a];
        b.isItemSelected(d) ? b.removeItem(b.selectedItems.indexOf(d), c) : b.addItem(d, c), 1 === b.options.selection.maximum ? b.showSelector = !1 : b.focusIdx = a
      }, b.addItem = function (a, c) {
        c.stopPropagation(), b.options.selection.maximum > 1 ? (b.selectedItems.length === b.options.selection.maximum && b.removeItem(b.selectedItems.length - 1, c), b.selectedItems.push(a)) : b.selectedItems[0] = a, f(a, b.config.OPERATION_ADD)
      }, b.removeItem = function (a, c) {
        c.stopPropagation();
        var d = b.selectedItems[a];
        (a === b.selectedItems.length - 1 || 2 === b.selectedItems.length) && b.closeOverlay(), b.selectedItems.splice(a, 1), f(d, b.config.OPERATION_DEL)
